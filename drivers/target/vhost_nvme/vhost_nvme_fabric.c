...
char *vhost_nvme_get_fabric_name(void)
{
	return "vhost_nvme";
}
...
int vhost_nvme_shutdown_session(struct se_session *se_sess)
{
	return 0;
}

void vhost_nvme_close_session(struct se_session *se_sess)
{
	return;
}
...
int vhost_nvme_write_pending_status(struct se_cmd *se_cmd)
{
	return 0;
}
